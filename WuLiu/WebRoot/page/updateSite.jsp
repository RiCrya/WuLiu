            ...
            <div class="row">
            	<div class="col-sm-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">地点信息修改
                        </li>
                    </ol>
                    <form role="form" action="${pageContext.request.contextPath}/SiteServlet?method=update?id=${param.id }" method="post" name="form1" onsubmit="return myCheck()">
                    	<div class="row">
							<div class="col-lg-3 form-group">
								<label for="name">&nbsp;地点</label>
								<input type="text" class="form-control" name="site_name" placeholder="文本输入" value="${param.name}">
							</div>
						</div>
						<div class="row">
