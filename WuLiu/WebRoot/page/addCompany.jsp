    ...
    <div class="container-fluid">
            <div class="row">
            	<div class="col-sm-12">
                    ...
                    <form role="form" action="${pageContext.request.contextPath}/CompanyServlet?method=add" method="post" name="form1" onsubmit="return myCheck()">
                    	<div class="row">
							<div class="col-lg-3 form-group">
								<label for="name">&nbsp;名称</label>
								<input type="text" class="form-control" name="companyName" placeholder="文本输入">
							</div>
						</div>
						<div class="row">
							<div class="col-lg-3 form-group">
						...
						<div class="row">
							<div class="col-lg-4 form-group">
								...
								<input type="text" class="form-control" name="price" placeholder="文本输入">
							</div>
						</div>
						<div class="row">
